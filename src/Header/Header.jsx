      ...
      <div className="max-w-[1600px] mx-auto px-6 h-20 md:h-28 flex items-center justify-between relative z-10">
        ...
        <div className="flex flex-col gap-0">
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            <span className="text-[10px] md:text-xs font-bold text-slate-400 uppercase tracking-[0.3em]">
              FlashReport Network
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          {/* LIVE button */}
          <div className="flex items-center bg-red-600 px-3 py-1.5 md:px-6 md:py-3 rounded-sm shadow-[0_0_25px_rgba(220,38,38,0.4)]">
            <div className="w-2 h-2 md:w-2.5 md:h-2.5 bg-white rounded-full animate-ping mr-2"></div>
