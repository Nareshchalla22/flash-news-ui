...
import {
  ...
  Film, Trophy, Activity, Landmark, Plane, Lock,
  Tv, Zap, Contact2, User, ShieldCheck, FileText,
  MapPin, HelpCircle, Newspaper,
} from 'lucide-react';
...
export const navItems = [
  ...
  { label: 'News Feed', path: '/news-feed',      icon: Newspaper },   // ← NEW
